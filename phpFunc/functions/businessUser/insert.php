...
#$sql2 get customer id where was data deleted (LIMIT to 1, only get one row).  if  count=0 mean no deleted row then normal insert , else update data into a delete row.
        ...
        $sql2="SELECT customer_id FROM crm_customer WHERE fname='' AND lname=''AND username='' AND mob='0' AND address='' AND email='' AND age='0' AND gender='' LIMIT 1";
        ...
        if($count==0){
            ...
            $sql = "INSERT INTO crm_customer (fname,lname,username,mob,address,email,age,gender) VALUES ('".$_POST['f_name']."','".$_POST['l_name']."','".$_POST['username']."','".$_POST['mob']."','".$_POST['address']."','".$_POST['email']."','".$_POST['age']."','".$_POST['gender']."')";
            ...
            $sql3 = "UPDATE crm_customer SET fname = '".$_POST['f_name']."', lname = '".$_POST['l_name']."','".$_POST['username']."', mob = '".$_POST['mob']."', address = '".$_POST['address']."', email = '".$_POST['email']."', age = '".$_POST['age']."', gender = '".$_POST['gender']."' WHERE customer_id = '".$row_cusid['customer_id']."'";
