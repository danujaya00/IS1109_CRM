...
<span class="logo-text">PiZzA</span><span class="small-title">Help<span style="color:#5875E6" >Center</span></span></a><!--  do stong -->

<p class="headline">Hello,How Can We Help You?</p> <div class="headline-line"></div>
...
<button onclick="window.location.href='Customer_Support.php';" class="box2">
...
<button onclick="window.location.href='Salesperson_Support.php';" class="box3">
